  ...
  return (
    <div className='baseContainer'>
      ...
      <div className='filterMenu'>
        <Link to='/projects' className='filterItem'> All </Link>
        <Link to='/projects' className='filterItem'> Software Development </Link>
        <Link to='/projects' className='filterItem'> UI/UX Design </Link>
        <Link to='/projects' className='filterItem'> Data Analytics </Link>
